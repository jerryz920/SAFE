...
postEndorsementLink "noauth:vm" "vm-builder" "image-keystone"
postEndorsement "vm-builder" "image-keystone" "source" "https://github.com/jerryz920/kvclient.git#master"

create() {
  for n in `seq 1 $N`; do
    echo "posting instance $n"
    postVMInstance $IAAS "keystoneclient" "image-keystone" "10.10.1.40:1-65535" "10.10.1.0/24" "vpc1" "noauth:vm"
...
checkkeystoneConnection "keystone" "10.10.1.40:43816"
done
